...
//        }
    ...
    public static EdgeIteratorState setDecimal(double fwd, double bwd, DecimalEncodedValue speedEnc, EdgeIteratorState edge) {
        setDecimal(fwd, bwd, speedEnc, Collections.singletonList(edge));
        return edge;
    }

    public static void setDecimal(double fwd, double bwd, DecimalEncodedValue speedEnc, EdgeIteratorState... edges) {
        setDecimal(fwd, bwd, speedEnc, Arrays.asList(edges));
    }

    public static void setDecimal(double fwd, double bwd, DecimalEncodedValue speedEnc, Collection<EdgeIteratorState> edges) {
        for (EdgeIteratorState edge : edges) {
